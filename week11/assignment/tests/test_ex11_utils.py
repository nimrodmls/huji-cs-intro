...
class TestFindPath:
    def test_basic_rows(self):
        ...
        expected = [[(0, 0), (0, 1), (0, 2)],
                    [(1, 0), (1, 1), (1, 2)],
                    [(2, 0), (2, 1), (2, 2)]]
        assert find_length_n_paths(3, board, word_dict) == \
               sorted(expected)
    ...
    def test_shared_letters(self):
        ...
        expected = [[(0, 0), (1, 0), (2, 0)],
                        [(0, 0), (0, 1), (0, 2)],
                        [(2, 2), (1, 2), (0, 2)]]
        assert sorted(find_length_n_paths(3, board, word_dict)) == \
               sorted(expected)
    ...
    def test_changed_direction(self):
        ...
        expected = [[(0, 0), (1, 1), (2, 2), (1, 2), (0, 2),
                     (0, 1)]]
        assert find_length_n_paths(6, board, word_dict) == expected
    ...
    def test_not_use_same_letter_twice(self):
        ...
        expected = []
        assert find_length_n_paths(7, board, word_dict) == expected
    ...
    def test_n_in_too_big(self):
        ...
        word_dict = {'CAT': True, 'DOG': True, 'BOT': True}
        expected = []
        assert find_length_n_paths(1000, board, word_dict) == expected
    ...
    def test_finds_correct_length_2(self):
        ...
        assert find_length_n_paths(4, board, word_dict) == expected
    ...
    def test_n_is_0(self):
        ...
        word_dict = {'D': True, 'O': True, 'G': True}
        expected = []
        assert find_length_n_paths(0, board, word_dict) == expected
    ...
    def test_long_dict(self):
        board = [['C', 'A', 'T', 'Q'],
                 ...
                 ['B', 'I', 'T', 'Q'],
                 ['Q', 'Q', 'Q', 'Q']]
        word_dict = load_words_dict(file_path("C:\\Projects\\huji-cs-intro\\week11\\assignment\\boggle_dict.txt"))
        expected = [[(0, 1), (1, 0), (1, 1)],
                    ...
                    [(0, 2), (1, 1), (2, 2)],
                    [(2, 2), (1, 1), (0, 2)]]
        assert sorted(find_length_n_paths(3, board, word_dict)) == sorted(expected)
...
class TestFindWords:
    ...
    def test_multi_letter_cells(self):
        ...
        word_dict = {'DOGS': True}
        expected = [[(1, 0), (1, 1), (1, 2)]]
        res = find_length_n_paths(3, board, word_dict)
        assert res == expected
    ...
    def test_max_score_paths(self):
        ...
        all_word_from_dict = load_words_dict(file_path("C:\\Projects\\huji-cs-intro\\week11\\assignment\\boggle_dict.txt"))  # Put all words from the dict
        for test_num in range(len(board)):
            result = max_score_paths(board[test_num], all_word_from_dict)
            res_dict ={''.join([board[test_num][i][j] for i, j in path]): path for path in result}
